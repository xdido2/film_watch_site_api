...
from users.views.forgot_password_view import ForgotPasswordActivateView, ForgotPasswordView
from users.views.register_view import RegisterView, ActivateAccountView
